...
form.addEventListener("submit", (event) => {
  ...
  } else if (validText(nameInput.value) == false) {
  ...
  } else if (validNum(numberInput.value) == false) {
  ...
  } else if (validNum(expMonthInput.value) == false) {
  ...
  } else if (validNum(expYearInput.value) == false) {
    expError.innerHTML = "Wrong format, only numbers";
  ...
  } else if (validNum(cvcInput.value) == false) {
